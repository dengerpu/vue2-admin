...
export default {
  ...
  login: {
    ...
    register: 'Register',
    username: 'Username',
    inputUsername: 'Please input an account',
    usernameLimit: 'Between 5 and 15 characters in length',
    password: 'Password',
    inputPassword: 'Please input a password',
    passwordLimit: 'Between 6 and 18 characters in length',
    code: 'Code',
    codeIllegal: 'The verification code is illegal',
    footer1: 'This website is created by@',
    footer2: 'provide technical support',
    any: 'any',
