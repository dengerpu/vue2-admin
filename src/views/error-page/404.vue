  ...
  <div class="wscn-http404-container">
    <div class="wscn-http404">
      ...
      <div class="bullshit">
        ...
        <a @click="goBack" class="bullshit__return-previous">Back to previous</a>
        <a @click="goHome" href="" class="bullshit__return-home">Back to home</a>
      </div>
    </div>
  </div>
</template>
...
.wscn-http404 {
  ...
  .bullshit {
    ...
    &__return-home, &__return-previous{
      display: block;
      float: left;
      width: 110px;
      height: 36px;
